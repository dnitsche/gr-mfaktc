...
void checkpoint_write(int base, unsigned int exp, int bit_min, int bit_max, int cur_class, int num_factors)
/*
...
*/
{
  ...
  {
    sprintf(buffer,"%s base=%d %u %d %d %d %s: %d %d", NAME_NUMBERS, base, exp, bit_min, bit_max, NUM_CLASSES, MFAKTC_VERSION, cur_class, num_factors);
    i=checkpoint_checksum(buffer,strlen(buffer));
    fprintf(f,"%s base=%d %u %d %d %d %s: %d %d %08X", NAME_NUMBERS, base, exp, bit_min, bit_max, NUM_CLASSES, MFAKTC_VERSION, cur_class, num_factors, i);
    fclose(f);
  }
}


int checkpoint_read(int base, unsigned int exp, int bit_min, int bit_max, int *cur_class, int *num_factors)
/*
  ...
  *num_factors=0;
  ...
  if(ptr==buffer)
  {
    ...
    if(i<70)
    {
      ...
      sprintf(buffer2,"%s base=%d %u %d %d %d %s: %d %d", NAME_NUMBERS, base, exp, bit_min, bit_max, NUM_CLASSES, MFAKTC_VERSION, *cur_class, *num_factors);
      chksum=checkpoint_checksum(buffer2,strlen(buffer2));
      sprintf(buffer2,"%s base=%d %u %d %d %d %s: %d %d %08X", NAME_NUMBERS, base, exp, bit_min, bit_max, NUM_CLASSES, MFAKTC_VERSION, *cur_class, *num_factors, chksum);
      if(*cur_class >= 0 && \
...
void checkpoint_delete(int base, unsigned int exp)
/*
